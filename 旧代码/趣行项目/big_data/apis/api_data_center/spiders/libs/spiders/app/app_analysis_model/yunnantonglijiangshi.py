...
# from App.spider_analy_model.fred20201212.appspider_m import Appspider
...
PROJECTID = 1
STYLEID = 357
TOKEN = '31a99f439449dd979cd790225c5b867ec80ae4284b92c7614bf4343e8b5f211b34a1989453262280024f21f7258d81cf7dc0083a2a8ad8b08d449430b207bdb41609324940444'
COOKIE = 'acw_tc=2f624a0216093249408345569e66ccdf6982b49f211488b7086f6845390945'
                    ...
                    try:
                        ...
                        if len(recommendlist) > 0:
                            for recomitem in recommendlist:
                                ...
                                for tjitem in tjlist:
                                    articleparam = self.formatearticlelist(tjitem, subchannelid, subchannelname, 0)
                                    articleparam["channelindexid"] = articleparam
                                    if articleparam:
                                        return articleparam
                    except Exception as e:
                        print("无 二级菜单 eee=", e)
