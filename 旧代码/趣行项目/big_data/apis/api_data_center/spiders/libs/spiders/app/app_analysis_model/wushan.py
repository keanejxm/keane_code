...
class WuShan(Appspider):
    ...
    def getarticlelistparams(self):
        channel_num = 0
        headers = {
            "Cookie": "PORSESSIONID=5AD27A68C282326F9F069EA7AAAAAD71",
        ...
        for channel in self.analyze_channel():
            ...
            data = {
                ...
                "lastSortNo": "",
                "lastOnlineTime": "",
                "sessionId": "4ab558814a92419f869904621ec461eb",
                "token": "",
            }
            method = 'post'
...
def fetch_yield(appname, logger, platform_id, self_typeid):
    appspider = WuShan(appname, logger, platform_id=platform_id, self_typeid=self_typeid)
