...
PROJECTID = 1
STYLEID = 367
TOKEN = '64bd2132f944555ecbae88eaca7d4e7aa1b84aae4c4084dcda0111b2c31bd543dbc0d215dfddedc37232e3296e1163d9089cd1753fcb5a7bc145a40708ba896f1608857820375'
COOKIE = 'acw_tc=707c9fd916088598491895831e4ce13e234586909ff61d4e3db08d6707a94f'
USERAGENT = 'YunNanTong/3.0.0 (iPhone; iOS 12.0.1; Scale/2.00)'
APPNAME = '云南通·迪庆洲'


class Yunnantongdiqingzhou(Appspider):
...
def fetch_yield(appname, logger, platform_id, self_typeid):
    appspider = Yunnantongdiqingzhou(appname, logger, platform_id=platform_id, self_typeid=self_typeid)
