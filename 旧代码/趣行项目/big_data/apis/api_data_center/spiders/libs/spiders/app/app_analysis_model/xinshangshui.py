            ...
            if channelname == "首页推荐":
                ...
                for topic in topicitems:
                    ...
                    if "needlogin=1" in topiclink:
                        ...
                        channelparam = InitClass().channel_fields(topiccatid, "首页快捷入口", categoryid=subchannelid,
                                                                  categoryname=subchannelname)
                        yield channelparam
                    else:
                        # 去要请求catid
                        ...
                        topicid = cids[1]
                        # 请求专题信息
                        topicurl = "https://app.shangshuitv.com/mag/info/v1/channel/channelConfigById?channel_id=" + str(
                            topicid)
                        topicheaders = {
                            "path": topicurl,
                            "authority": "app.shangshuitv.com",
                ...
                for topic in topicitems:
                    ...
                    if "cat_id=" in topiclink:
                        ...
                        # categoryid 新channelid
                        # categoryname 新 channelname
                        channelparam = InitClass().channel_fields(topiccatid, "工作专题", categoryid=subchannelid,
                                                                  categoryname=subchannelname)
                        yield channelparam
                    else:
                        # 去要请求catid
                    ...
                    if channelname == "首页banner":
                        ...
                        for article in article_list:
                            if "_name" in article.keys():
                                ...
                                # 请求专题id
                                tmpurl = "https://app.shangshuitv.com/mag/info/v1/Info/infoSubject?subject_id=" + str(
                                    subid)
        ...
        for article in self.analyze_articlelists(articleslistsres):
            ...
            if topic == 1:
                ...
                openurl = "https://app.shangshuitv.com//mag/info/v1/info/infoView?id=" + str(
                    articleid) + "&mag_hide_progress=1&themecolor=D00403"
                article["url"] = openurl
            ...
            if topic:
                try:
                    ...
                    for article in topiclist:
                        ...
                        aurl = "https://app.shangshuitv.com//mag/info/v1/info/infoView?mag_hide_progress=1&themecolor=D00403&id=" + str(
                            article_id)
                        aheaders = {
                            "method": "GET",
                            "authority": "app.shangshuitv.com",
