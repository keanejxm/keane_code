...
class Yunnantongnujiangzhou(Appspider):
    ...
    def formatearticlelist(article, channelid, channelname):
        ...
        if contenttype == 64:
            ...
            # 将请求文章必需信息存入
            topic_fields["contenttype"] = contenttype
            return topic_fields
...
def fetch_yield(appname, logger, platform_id, self_typeid):
    appspider = Yunnantongnujiangzhou(appname, logger, platform_id=platform_id, self_typeid=self_typeid)
