...
class Yunnantongdalizhou(Appspider):
    ...
    def get_app_params():
        ...
        # 频道请求头
        headers = {
            "token": "3f69a6ad27e5628528f581e9c782eeda20fbeaa5419b0e8c08f8b11c52fdbfaa69d6dcdd1082add87a3786667614eb5aed48cb23f44777a1f6bf6c8b061d5a1c1608020896413",
            "random": "999",
    ...
    def getarticleparams(self, articleslist_ress):
        ...
        for articleparam in self.analyze_articlelists(articleslist_ress):
            ...
            channel_index_id = articleparam.get(channel_index_id)
...
def fetch_yield(appname, logger, platform_id, self_typeid):
    appspider = Yunnantongdalizhou(appname, logger, platform_id=platform_id, self_typeid=self_typeid)
