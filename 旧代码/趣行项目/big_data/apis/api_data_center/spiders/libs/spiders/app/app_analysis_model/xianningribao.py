...
class Xianningribao(Appspider):
    ...
    def getarticlelistparams(self, channelsres):
        ...
        for channel in self.analyze_channel(channelsres):
            ...
            url = "http://dq.xianning.gov.cn/api/wcm/document/getByChnlId.do?userId=&pageIndex=1&clientId=xnnews&c" \
                  "lientSecret=eG5OZXdzQDIwMTgjQCNA&chnlId=" + str(
                channelid)
                    ...
                    for section in childlist:
                        ...
                        for article in datalist:
                            ...
                            detailjson = json.loads(
                                json.dumps(json.loads(itemres, strict=False), indent=4, ensure_ascii=False))
...
def fetch_yield(appname, logger, platform_id, self_typeid):
    appspider = Xianningribao(appname, logger, platform_id=platform_id, self_typeid=self_typeid)
