...
class JiaZaiFengJie(Appspider):
    ...
    def getarticlelistparams(self):
        headers = {
            "Cookie": "PORSESSIONID=6504DB83A2FBA85ECEA457CB01A43CEF",
        ...
        channel_num = 0
        for channels in self.analyze_channel():
            channel_num += 1
            for channel in channels:
                ...
                data = {
                    ...
                    "lastSortNo": "",
                    "lastOnlineTime": "",
                    "sessionId": "c9badfde3b324b7ba4c8545599391114",
                    "token": "",
                }
                method = 'post'
    ...
    def getarticleparams(self, articleslistsres):
        for article in self.analyze_articlelists(articleslistsres):
            ...
            if topic == 1:
                ...
                headers = {
                    "Cookie": "PORSESSIONID=189CA198D32A48170BF221445FDABBE0",
                    "Content-Type": "application/x-www-form-urlencoded;charset=UTF-8",
                    "Content-Length": "31",
                    "User-Agent": "Dalvik/2.1.0 (Linux; U; Android 6.0.1; MuMu Build/V417IR)",
                    "Host": "api.cqliving.com",
                ...
                headers = {
                    ...
                    "User-Agent": "Mozilla/5.0 (Linux; Android 6.0.1; MuMu Build/V417IR; wv) AppleWebKit/537.36 (KHT"
                                  "ML, like Gecko) Version/4.0 Chrome/52.0.2743.100 Mobile Safari/537.36 CQ_XHL(2026;"
                                  "Android;20;c9badfde3b324b7ba4c8545599391114;;0)",
                    "Content-Type": "application/x-www-form-urlencoded",
                    "Referer": "https://share.cqliving.com/news-detail-pages/",
                    "Accept-Encoding": "gzip, deflate",
                    "Accept-Language": "zh-CN,en-US;q=0.8",
                    "X-Requested-With": "com.xhl.fengjie",
                }
                data = {
                    "infoClassifyId": articleid,
                }
        ...
        for article in articleres:
            ...
            if topic:
                ...
                for articles in content_s["data"]["firstPageData"]["dataList"]:
                    ...
                    for article_param in self.getarticleparams([articleparam]):
                        for article_res in self.getarticlehtml(article_param):
                            self.getarticlehtml(article_res)
...
def fetch_yield(appname, logger, platform_id, self_typeid):
    appspider = JiaZaiFengJie(appname, logger, platform_id=platform_id, self_typeid=self_typeid)
