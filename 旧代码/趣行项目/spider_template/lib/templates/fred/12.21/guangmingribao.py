...
class Guangmingribao(Appspider):
    ...
    def analyze_channel(channelsres):
        ...
        my_list = channelslists["data"]["myChannels"]
        more_list = channelslists["data"]["moreChannels"]
        for channel in my_list + more_list:
    ...
    def getarticlelistparams(channelsparams):
        ...
        for channel in channelsparams:
            ...
            headers = {
                ...
                "ua": "IOS+iPhone 6s+9.0.2+",
                "user-agent": "guang ming ri bao/9.0.2 (iPhone; iOS 12.0.1; Scale/2.00)",
                "cookie": "jcloud_alb_route=62769a163490b15fce64c021fd0f1864"
            }
