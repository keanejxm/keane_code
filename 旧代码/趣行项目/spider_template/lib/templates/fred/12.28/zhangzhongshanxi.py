...
class Zhangzhongshanxi(Appspider):
    ...
    def analyze_channel(channelsres):
        ...
        # columnstyle = "101"
        # topcount = 0
        # channelparam = InitClass().channel_fields(channelid, channelname, categoryid=topcount, categoryname=columnstyle)
            ...
            if topic:
                try:
                    ...
                    for column in ztsections:
                        ...
                        time.sleep(0.5)
                        sectionjson = json.loads(json.dumps(json.loads(sectionres, strict=False), indent=4, ensure_ascii=False))
...
if __name__ == '__main__':
    appspider = Zhangzhongshanxi("掌中陕西")
    appspider.run()
