...
class Wenyiyun(Appspider):
    ...
    def getarticlelistsparams(channelsparams):
        ...
        for channel in channelsparams:
            ...
            articlelist_param = InitClass().articlelists_params_fields(url, headers, method, channelname, channelid = channelid, data = data,channeljson=channel_json)
    ...
    def getarticleparams(articles):
        ...
        for articleparam in articles:
            ...
            # 此处代码不需要改动
            channelname = articleparam.get("channelname") #banner
            channelid = articleparam.get("channelID") #banner
            imgurl = articleparam.get("imageurl") #banner
            articleurl = articleparam.get("articleurl")  # banner
            videocover = channelid
            ...
            article = InitClass().article_params_fields(url, headers, method, channelname, imageurl = imgurl, data = data,articlejson=detail_josn,
    ...
    def analyzearticles(articles_res):
        for articleres in articles_res:
            ...
            url = articleres.get("videourl") #普通新闻url
            ...
            articleurl = articleres.get("articleurl") #banner
