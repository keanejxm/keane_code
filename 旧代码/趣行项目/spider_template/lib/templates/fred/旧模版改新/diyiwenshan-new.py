...
PROJECTID = 1
STYLEID = 112
TOKEN = '44eaf7e9ca8b08203960f5d21fd533c40e4abca60db4ca25d44fbce38e05b5add6e1662654f5308d43afacc395b30f8390c851a73ed' \
        '97da8fd62373c13d4aed61608788420604'
COOKIE = 'acw_tc=2f624a4816087884205993602e310e5405703394e30e732180a80c9c52122d'
USERAGENT = 'di yi wen shan/3.2.0 (iPhone; iOS 12.0.1; Scale/2.00)'
APPNAME = '第一文山'
                    ...
                    for themeitem in themedata:
                        ...
                        for normalarticle in contentlist:
                            ...
                            if template in H5ARTICLES:
                                ...
                                # 请求详情
                                if template == 'TNWS501':
                                    detail_url = "https://apiparty.xinhuaapp.com/Service/ContentSvr.svc/GetContent" \
                                                 "DetailByVideo"
                                else:
                                    detail_url = "https://apiparty.xinhuaapp.com/Service/ContentSvr.svc/GetContent" \
                                                 "Detail"
                                ...
                                detailres = requests.get(detail_url, headers = detail_headers,
                                                         params = detail_data).text
