...
class Jingjicankaobao(Appspider):
    ...
    def getarticlelistsparams(channelsparams):
        ...
        for channel in channelsparams:
            ...
            articlelist_param = InitClass().articlelists_params_fields(url, headers, method, channelname,channelid=channelid, data = data,banners=bannercount)
    ...
    def getarticleparams(articles):
        ...
        for articleparam in articles:
            ...
            article = InitClass().article_params_fields(url, headers, method, channelname, imageurl= imgurl, sleeptime=1,data = data,
        ...
        for articleres in articles_res:
            ...
            try:
                ...
                if isnormal:
                    ...
                    print("normal articlejson==",articlejson)
                    ...
                    videoslist = list()
                    videoscovers = list()
                    contentvideos = articlejson["videos"]
                    # print("contentvideos==",contentvideos)
                    for videoitem in contentvideos:
                        videourl = videoitem["videoUrl"]
                        videocoverurl = videoitem["imageUrl"]
                        videoslist.append(videourl)
                        videoscovers.append(videocoverurl)
                    fields["videos"] = videoslist
                    fields["videocover"] = videoscovers

                    contentimgs = list()
                    contentimages = articlejson["images"]
                    for imageitem in contentimages:
                        cimgurl = imageitem["imageUrl"]
                        contentimgs.append(cimgurl)
                    fields["images"] = contentimgs
