...
class ChongQingJiangBei(Appspider):

    def analyze_articlelists(self):
        channelsid = [['1100', '首页']]
        for channel in channelsid:

            r = Appspider.send_request(self, {
    ...
    def analyzearticle(self, article_item):
        ...
        if 'xhpfmapi' in url:
            ...
            try:
                ...
                r = r.encode("ISO-8859-1").decode("utf8")
                html = etree.HTML(r)
