...
class ChongQingRongCahng(Appspider):

    def analyze_articlelists(self):
        channelsid = [['5300', '首页'], ['5304', '本地'], ['5305', '部门'], ['5306', '街镇'], ['5307', '国内'],
                      ['1130', '专题'], ]
