...
class DaMeiQiJiang(Appspider):
    ...
    def analyzearticle(self, article_item):
        ...
        if '/graphic/graphic' in url:
            ...
            article_item['videos'] = html.xpath('//*[@class="cnt_bd"]//video/@src')
            ...
            try:
                ...
                if not article_item['content']:
                    article_item['content'] =html.xpath('string(/html/body/div[8]/div[1]/div)')
                    article_item['images']=html.xpath('/html/body/div[8]/div[1]/div//img/@src')
