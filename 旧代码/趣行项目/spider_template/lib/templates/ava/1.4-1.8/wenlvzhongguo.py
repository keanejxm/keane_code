...
class wenlvzhongguo(Appspider):
    ...
    def analyze_channel(channelsres):
        ...
        channelparams = []
        navlist = [{
            "channelid": "2eeab938-cac7-4743-b45e-a7b176ff595f",
            "channelname": "小视频"
        }]
    ...
    def getarticlelistparams(channelsparams):
        ...
        for channel in channelsparams:
            ...
            data = {}
            method = 'post'
            channeljson = {"clientType":"api","clitype":"android","columnId":channelid,"currentPage":"1","gid":"080027f86771","imei":"4b8408b015d70ec4","pageSize":"10","terminalId":"1","token":""}
                            ...
                            if "items" in articles.keys():
                                for articles_list in articles['items']:
                                    if find2 in articles_list['action']:
                                        ...
                                        article_id = idlist[-1]
                                        res=requests.get(f'https://www.ccmapp.cn/middleware/getdetail?terminalId=1&type=special&id={article_id}').content.decode()
    ...
    def getarticleparams(articles):
        ...
        for article in articles:
            ...
            if topic == 1:
                ...
                data = {}
                articlejson={"clientType":"api","clitype":"android","columnId":articleid,"currentPage":"1","gid":"080027f86771","imei":"4b8408b015d70ec4","pageSize":"10","terminalId":"1","token":""}
                method = 'post'
            else:
            ...
            articleparam = InitClass().article_params_fields(url, headers, method, data = data,
                                                             article_field = article_field,articlejson = articlejson)
