                ...
                try:
                    if channelname == '首页':
                        for article_list in articleslists:
                            if article_list['name'] == '视频' or article_list['name'] == '习近平专题' or article_list['name'] == '48小时热榜' or article_list['name'] == '轮转图':
                ...
                try:
                    ...
                    try:
                        if 'video' in content_s.keys():
                            ...
                            videoss = [content_s["video"]["host"]+content_s["video"]["dir"]+content_s["video"]["filepath"]+content_s["video"]["filename"]]
